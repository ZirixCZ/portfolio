            ...
            <div className="h-screen w-screen overflow-hidden flex items-center justify-center bg-Black text-White">
                <div className="xl:h-2/4 h-full w-full xl:w-5/6 bg-Black mt-32 xl:mt-0 rotate-anim">
                    ...
                    <div className="h-full w-full bg-Black rounded-2xl flex flex-col justify-center">
                        ...
                        <p className="m-5 xl:m-20 text-lg xl:text-2xl">Discord bot created to show information about the timetable. E.g time until certain events take place. Inspired by the Delta Time mobile app by MadSoft.cz.   <a className="MainColorTheme  underline" href={link} target="_blank">Check it out on GitHub</a></p>
