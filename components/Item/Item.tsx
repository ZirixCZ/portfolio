...
const Item: React.FC<ItemProps> = ({
  ...
  return (
    <div className="flex justify-center mb-20 w-full h-28">
      <Link href={link}>
        <div className="flex w-10/12 md:w-7/12 h-full border-4 rounded-md itemBorder cursor-pointer xl:w-32rem itemLong hover:-translate-y-1 duration-300 transition ease-in-out">
